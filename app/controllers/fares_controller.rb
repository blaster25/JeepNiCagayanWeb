class FaresController < ApplicationController
  ...
  def currentFare
    @fare = Fare.last
   render :json => @fare
    # format.json { render :show, location: @fare }
  end
  ...
  private
    ...
    def fare_params
      params.require(:fare).permit(:farePriceReg, :farePriceSp, :fareIncReg, :fareIncSp, :fareDescription)
    end
end
